...
function PaymentForm({
  ...
  return (
    <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
      <div className="bg-[#3a4a2a] rounded-lg border border-[#CCFF00] p-6">
      ...
      <div className="bg-[#2a2a2a] rounded-lg p-6 border border-gray-700">
        ...
        <div className="space-y-4">
          <div>
            ...
            <input
              ...
              className="w-full bg-gray-900 border border-gray-700 rounded px-4 py-3 text-white focus:outline-none focus:border-[#CCFF00]"
            />
          </div>
        ...
        <button
          onClick={handlePay}
          disabled={!canSubmit}
          className="mt-6 w-full px-6 py-3 bg-[#CCFF00] text-black font-bold rounded hover:bg-[#B8E600] transition disabled:opacity-60 disabled:cursor-not-allowed"
        >
        ...
        <div className="flex items-center justify-center mb-12 gap-8">
          {[1, 2].map((step) => (
            <React.Fragment key={step}>
              {step > 1 && (
                <div
                  className={`w-10 h-1 ${step <= currentStep ? "bg-[#CCFF00]" : "bg-gray-700"}`}
                />
              )}
              <div
