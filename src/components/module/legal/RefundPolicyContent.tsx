    ...
    <PolicyLayout title="Refund Policy" effectiveDate="March 2026">
      ...
      <section>
        ...
        <div className="overflow-x-auto border border-[#2d2d2d] rounded-lg">
          <table className="w-full text-sm text-left">
            <thead className="bg-[#151515] text-[#CCFF00]">
              <tr>
      ...
      <section>
        ...
        <p>
          ...
          substitution by emailing info@league.dev. Approval is case by case and
          is the sole remedy under this section.
        </p>
      </section>
      ...
      <section>
        ...
        <ul className="list-disc pl-6 space-y-2">
          <li>Email refund requests to info@league.dev.</li>
          <li>
