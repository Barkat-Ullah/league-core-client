...
function statusColor(badge: StatusBadge) {
  if (badge === "QUALIFIED") return "text-[#CCFF00]";
...
export default function StandingsPage() {
  const [selectedDivision, setSelectedDivision] = useState<Division>("U9_BOYS");
  ...
  return (
    <div className="bg-black min-h-screen">
      ...
      <div className="max-w-6xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="bg-[#1a1a1a] border-2 border-[#CCFF00] rounded-lg mb-8 sm:mb-12 py-5 sm:py-6 px-4 sm:px-6">
          <div className="grid grid-cols-1 md:grid-cols-2 gap-6 md:gap-10">
            ...
            <div>
              ...
              <select
                ...
                className="w-full px-4 py-3 bg-black border border-[#CCFF00] rounded text-white text-sm sm:text-base focus:outline-none cursor-pointer"
                style={{ fontFamily: "Open Sans" }}
              >
            ...
            <div>
              ...
              <div
                className="bg-[#2b331e] border border-[#CCFF00] rounded px-4 py-3"
                style={{ fontFamily: "Open Sans" }}
              >
                ...
                <a
                  href="/rules"
                  className="inline-flex items-center gap-1 mt-2 text-[#CCFF00] hover:underline font-semibold text-xs sm:text-sm"
                >
          ...
          {/* Meta */}
          <div
            className="bg-[#2b331e] border border-[#CCFF00] rounded px-4 py-3 w-full mt-4"
            style={{ fontFamily: "Open Sans" }}
          >
            {meta ? (
          ...
          <div className="flex items-start justify-between gap-4 flex-wrap">
            <div className="min-w-55">
              ...
              <p className="text-gray-400 text-xs sm:text-sm">
                Qualifying for:{" "}
                <span className="text-[#CCFF00]">Crown Series (June 2026)</span>
              </p>
            </div>
                ...
                <tbody>
                  {!isLoading && standings.length === 0 ? (
                    ...
                    standings.map((row) => (
                      ...
                      >
                        <td className="py-4 px-2 text-[#CCFF00] font-bold text-base sm:text-lg">
                          {row.rank}
                        </td>
                        ...
                        <td className="py-4 px-2 text-center text-[#CCFF00] font-bold text-sm sm:text-base">
                          {row.points}
                        </td>
                        <td
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-4 sm:gap-6 mb-12 sm:mb-20">
          ...
          <div className="bg-[#2b331e] border-2 border-[#CCFF00] rounded-lg p-5 sm:p-6">
            ...
            <a
              href="/rules"
              className="inline-flex items-center gap-2 text-[#CCFF00] hover:underline font-semibold text-sm sm:text-base transition"
              style={{ fontFamily: "Open Sans" }}
            >
              See Full Rules <span>→</span>
            </a>
          ...
          {/* Final Date */}
          <div className="bg-[#2b331e] border-2 border-[#CCFF00] rounded-lg p-5 sm:p-6 flex flex-col justify-center">
            <div className="text-center">
              ...
              <p className="text-[#CCFF00] font-bold text-2xl sm:text-3xl mb-2 font-['Oswald'] leading-tight">
