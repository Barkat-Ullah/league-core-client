  ...
  return (
    <div className="bg-black min-h-screen">
      ...
      <div className="max-w-[90%] mx-auto px-4 sm:px-6 py-16">
              ...
              {section.questions.map((item) => (
                <div key={item.id}>
                  ...
                  >
                    ...
                    <ChevronDown
                      className={`w-5 h-5 text-[#CCFF00] transition-transform ${
                            ...
                            <table className="min-w-130 border border-[#333] text-left text-sm text-gray-300">
                              <thead>
                                <tr className="bg-[#1a1a1a]">
                                  <th className="px-3 py-2 border-b border-[#333] text-[#CCFF00] font-semibold">
                                    Division
                                  </th>
                                  <th className="px-3 py-2 border-b border-[#333] text-[#CCFF00] font-semibold">
                                    Birthdate Timeline
        ...
        <section
          className="bg-linear-to-l from-[#220A13] to-[#1D2109] border-2 border-[#CCFF00] rounded-lg p-8 text-center mb-20"
          id="#contact"
        >
          ...
          <div className="flex flex-col sm:flex-row items-center justify-center gap-4">
            <a
              ...
              className="bg-[#CCFF00] hover:bg-[#B8E600] text-black font-bold py-3 px-8 rounded-lg transition flex items-center gap-2"
            >
              <Mail className="w-5 h-5" />
              Email Us
            </a>
            <a
              href="tel:013333333333"
              className="border-2 border-[#CCFF00] text-[#CCFF00] hover:bg-[#CCFF00] hover:text-black font-bold py-3 px-8 rounded-lg transition flex items-center gap-2"
            >
