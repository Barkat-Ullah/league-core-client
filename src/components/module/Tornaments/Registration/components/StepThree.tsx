...
export default function StepThree({
  ...
  const stripeElementBase =
    "w-full bg-gray-900 text-white border border-gray-700 rounded px-4 py-3 focus-within:border-[#CCFF00] transition";
        ...
        {isProcessing ? (
          <div className="absolute inset-0 z-20 flex items-center justify-center rounded-md bg-black/60 backdrop-blur-[1px]">
            <div className="flex items-center gap-2 text-sm font-semibold text-white">
              <Loader className="h-5 w-5 animate-spin text-[#CCFF00]" />
              Processing payment...
            </div>
          </div>
        ) : null}
        {/* Summary */}
        <div className="border border-[#CCFF00] p-4 rounded-md bg-[#2B3017]">
