      ...
      <div className="space-y-6">
        ...
        <div>
          ...
          <select
            ...
            className="w-full bg-gray-900 text-white border border-gray-700 rounded px-4 py-3 focus:outline-none focus:border-[#CCFF00] transition disabled:opacity-50"
          >
            <option value="">
              {selectedTournamentData
