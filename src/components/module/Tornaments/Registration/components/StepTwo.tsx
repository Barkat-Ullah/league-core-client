      ...
      <div className="space-y-6">
        ...
        {isExisting && (
          <div>
            ...
            <select
              ...
              className="w-full bg-gray-900 text-white border border-gray-700 rounded px-4 py-3 focus:outline-none focus:border-[#CCFF00] transition"
            >
        ...
        <div>
          ...
          <input
            ...
            className="w-full bg-gray-900 text-white border border-gray-700 rounded px-4 py-3 focus:outline-none focus:border-[#CCFF00] transition placeholder-gray-600"
            required
          />
        </div>
