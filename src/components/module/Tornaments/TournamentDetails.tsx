  ...
  return (
    <div className="bg-black min-h-screen mt-10">
        ...
        <div className="max-w-7xl mx-auto mb-10 rounded-lg">
          <div className="flex items-start justify-between mb-6">
            <div>
              ...
              <div className="w-16 h-1 bg-[#CCFF00] rounded"></div>
            </div>

            <span className="border border-[#CCFF00] text-[#CCFF00] text-sm font-bold px-4 py-2 rounded">
              {tournament.status}
            </span>
          </div>
          ...
          {tournament.prizePool && (
            <div className="mt-4 bg-[#240303] border border-[#333] rounded-lg p-4">
              ...
              <p className="text-[#CCFF00] font-semibold whitespace-pre-wrap">
                {tournament.prizePool}
              </p>
            </div>
          )}
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 py-12">
        {/* Divisions Section */}
        <section className="mb-12 bg-[#1a1a1a] border border-[#CCFF00] rounded-lg p-6">
          <h2 className="text-2xl font-bold text-white mb-2 flex items-center gap-2">
            <span className="text-[#CCFF00]">⚡</span> DIVISIONS OFFERED THIS
            WEEK
          </h2>
        ...
        <section className="bg-[#1a1a1a] border border-[#333] rounded p-6 mb-12">
          <h3 className="text-xl font-bold text-white mb-4 flex items-center gap-2">
            <span className="text-[#CCFF00]">⚽</span> TOURNAMENT FORMAT
          </h3>
        ...
        <section className="bg-[#1a1a1a] border border-[#333] rounded p-6 mb-12">
          <h3 className="text-xl font-bold text-white mb-4 flex items-center gap-2">
            <span className="text-[#CCFF00]">👥</span> ROSTER REQUIREMENTS
          </h3>
          <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
            <div>
              <h4 className="text-[#CCFF00] font-semibold mb-3">Roster Size</h4>
            ...
            <div>
              <h4 className="text-[#CCFF00] font-semibold mb-3">Stage</h4>
              <ul className="space-y-2 text-gray-300 text-sm">
                <li className="flex items-start gap-2">
                  <span className="text-[#CCFF00] font-bold">•</span>
        ...
        {/* CTA Section */}
        <section className="bg-[#1a1a1a] border border-[#CCFF00] rounded-lg p-8 mb-12">
          ...
          <a
            href="/rules"
            className="inline-flex items-center gap-2 bg-[#CCFF00] hover:bg-[#B8E600] text-black font-bold py-3 px-8 rounded-lg transition"
          >
        ...
        {/* CTA Section */}
        <section className="bg-linear-to-r from-[#1D2109] to-[#220A13] border-2 border-[#CCFF00] rounded-lg p-8 text-center mb-12">
          ...
          <button
            ...
            className="bg-[#CCFF00] hover:bg-[#B8E600] text-black font-bold py-3 px-12 rounded-lg shadow-lg transition mb-4 cursor-pointer"
          >
            Register Your Team
          </button>
