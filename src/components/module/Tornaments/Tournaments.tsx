  ...
  return (
    <div className="bg-black min-h-screen">
      ...
      <div className="max-w-[90%] mx-auto px-4 sm:px-6 py-12">
        ...
        <div className="flex flex-col md:flex-row gap-4 mb-12">
          <div className="flex-1 relative">
            ...
            <input
              ...
              className="w-full pl-10 pr-4 py-2.5 bg-[#1a1a1a] border border-[#333] rounded text-white placeholder-gray-500 focus:outline-none focus:border-[#CCFF00]"
              style={{ fontFamily: "Open Sans" }}
            />
          </div>
            ...
            {debouncedSearch ? (
              <div className="mt-6">
                <button
                  ...
                  className="bg-[#CCFF00] hover:bg-[#B8E600] text-black font-bold py-3 px-8 rounded-sm transition"
                >
                  Clear Search
                </button>
              </div>
              ...
              {tournaments.map((tournament: any) => (
                ...
                >
                  ...
                  <div className="absolute top-3 right-3 z-10">
                    <span className="border border-[#CCFF00] text-[#CCFF00] text-xs font-semibold px-3 py-1 rounded">
        ...
        {/* Info Section */}
        {/* Info Section */}
        <section className="mb-12 rounded-xl border border-[#CCFF00]/45 bg-[linear-gradient(100deg,#3F464C_0%,#363D43_45%,#B8E600_140%)] p-6 sm:p-8">
          ...
          >
            <li className="flex items-center gap-3">
              <span className="shrink-0 font-bold text-[#CCFF00] leading-none">
                •
              </span>
