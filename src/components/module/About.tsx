  ...
  return (
    <div className="bg-black min-h-screen">
      ...
      <section className="relative h-75 bg-cover bg-center flex items-center justify-center overflow-hidden">
        ...
        <div className="relative z-10 text-center">
          <div className="pb-2">
            ...
            <div className="w-25 border-2 border-[#CCFF00] mx-auto" />
          </div>

          <p
            className="text-[#CCFF00] text-lg font-semibold "
      ...
      <div className="max-w-[90%] mx-auto px-4 sm:px-6 py-16">
        ...
        <section className="bg-[#1a1a1a] border-l-4 border-l-[#CCFF00] border-r-2 border-r-[#00CCFF] rounded-lg p-6 mb-12">
        ...
        <section className="bg-[#1a1a1a] border-l-4 border-l-[#CCFF00] border-r-2 border-r-[#00CCFF] rounded-lg p-6 mb-12">
          ...
          >
            <div>
              <h3 className="text-[#CCFF00] font-bold mb-2">
                <span className="text-[#CCFF00]">•</span> Pop-up tournaments
                across DFW
              </h3>
              <p>
            ...
            <div>
              <h3 className="text-[#CCFF00] font-bold mb-2">
                <span className="text-[#CCFF00]">•</span> Open access at every
                level
              </h3>
              <p>
            ...
            <div>
              <h3 className="text-[#CCFF00] font-bold mb-2">
                <span className="text-[#CCFF00]">•</span> Performance-based
                progression
              </h3>
              <p>
            ...
            <div>
              <h3 className="text-[#CCFF00] font-bold mb-2">
                <span className="text-[#CCFF00]">•</span> Player development
                focus
              </h3>
              <p>
        ...
        <section className="bg-[#1a1a1a] border-2  rounded-lg p-8 mb-12">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
            <div className="bg-black border  rounded-lg p-6 text-center">
              <p className="text-[#CCFF00] font-bold text-4xl mb-2">4X</p>
              <p className="text-gray-300 text-sm">
                More ball touches per player vs 11v11
              </p>
            </div>
            <div className="bg-black border  rounded-lg p-6 text-center">
              <p className="text-[#CCFF00] font-bold text-4xl mb-2">100%</p>
              <p className="text-gray-300 text-sm">
                Players engaged in the action
              </p>
            </div>
            <div className="bg-black border  rounded-lg p-6 text-center">
              <p className="text-[#CCFF00] font-bold text-3xl mb-2">More</p>
              <p className="text-gray-300 text-sm">
                Tactical decisions every minute
              </p>
            </div>
            <div className="bg-black border  rounded-lg p-6 text-center">
              <p className="text-[#CCFF00] font-bold text-3xl mb-2">Better</p>
              <p className="text-gray-300 text-sm">
        ...
        <section className="bg-[#1a1a1a] border border-[#333] rounded-lg p-6 mb-12">
          ...
          {/* Team Images */}
          <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
            <div className="relative h-150 rounded-4xl overflow-hidden border-3 border-[#CCFF00]">
              <Image
                src="/team1.png"
                alt="Team photo 1"
                fill
        ...
        {/* Get In Touch CTA */}
        <section className="bg-linear-to-r from-[#0D272B] to-[#2B2517] border-2 border-[#CCFF00] rounded-lg p-8 text-center mb-20 max-w-xl mx-auto">
          <h2 className="text-white font-bold text-2xl mb-6 font-['Oswald']">
            GET IN TOUCH
          </h2>
          <div className="flex flex-col md:flex-row items-center justify-center gap-6 mb-8">
            <a
              href="mailto:info@league.dev"
              className="flex items-center gap-2 text-[#CCFF00] font-semibold hover:underline"
            >
          ...
          <Link href="/tournaments">
            <button className="bg-[#CCFF00] hover:bg-[#B8E600] text-black font-bold py-3 px-8 rounded-lg shadow-lg transition">
              View Tournaments
            </button>
          </Link>
        </section>
