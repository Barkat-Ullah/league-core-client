  ...
  const steps = [
    {
      ...
      color: "#CCFF00",
      borderClass: "border-l-4 border-l-[#CCFF00]",
      numberBg: "bg-[#CCFF00]",
    },
    {
      id: 2,
      ...
      <div className="mx-auto max-w-[90%] px-4 py-12 sm:px-6 sm:py-14 lg:py-16">
        ...
        <div className="mb-10 flex justify-center">
          <Link href="/tournaments" className="w-full sm:w-auto">
            <button className="w-full rounded-lg bg-[#CCFF00] px-8 py-3 text-base font-bold text-black shadow-lg transition hover:bg-[#B8E600] sm:w-auto sm:px-12 sm:text-lg font-['Oswald']">
