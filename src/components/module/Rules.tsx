      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8 md:py-12">
        <div className="grid grid-cols-1 lg:grid-cols-4 gap-6">
          ...
          <aside className="lg:col-span-1">
            <div className="sticky top-24 bg-[#1a1a1a] border-2 border-[#CCFF00] rounded-lg p-4 md:p-6">
                  ...
                  <button
                    ...
                    className={`w-full text-left px-3 py-2 rounded transition-colors text-sm md:text-base ${
                      activeSection === section.id
                        ...
                        : "text-gray-300 hover:text-[#CCFF00] hover:bg-[#2a2a2a]"
                    }`}
                    style={{ fontFamily: "Open Sans" }}
                  >
                    {section.label}
              ...
              {/* Download PDF Button */}
              <button
                className="w-full mt-6 bg-[#CCFF00] text-black font-bold py-3 rounded-lg hover:bg-[#B8E600] transition flex items-center justify-center gap-2"
                style={{ fontFamily: "Open Sans" }}
              >
          ...
          <main className="lg:col-span-3 space-y-8">
            ...
            <section
              id="game-format"
              className="bg-[#1a1a1a] border-l-4 border-l-[#CCFF00] rounded-lg p-6 md:p-8"
            >
              ...
              >
                <p>
                  <strong className="text-[#CCFF00]">Team Size:</strong> 7v7
                  (seven players per side on the field at one time)
                </p>
                <p>
                  <strong className="text-[#CCFF00]">Field Size:</strong> 50-65
                  yards long x 30-40 yards wide, depending on venue
                </p>
                <p>
                  <strong className="text-[#CCFF00]">Ball Size:</strong>{" "}
            ...
            >
              ...
              >
                <p>
                  <strong className="text-[#CCFF00]">Game Length:</strong> Two
                  12-minute halves (24 minutes total) for all divisions
                </p>
                <p>
                  <strong className="text-[#CCFF00]">Clock Style:</strong>{" "}
                  Running clock throughout (no stop time for substitutions or
                  throw-ins)
                </p>
                <p>
                  <strong className="text-[#CCFF00]">Halftime:</strong> Short
            ...
            >
              ...
              >
                ...
                <p>
                  <strong className="text-[#CCFF00]">On-the-Fly:</strong>{" "}
              ...
              >
                ...
                <div className="bg-[#2a2a2a] rounded-lg p-4 space-y-3">
                  <div className="flex items-center justify-between">
                    <span>
                      <strong className="text-[#CCFF00]">Win:</strong> 3 points
                    </span>
                  </div>
                  <div className="flex items-center justify-between">
                    <span>
                      <strong className="text-[#CCFF00]">Tie:</strong> 1 point
                    </span>
                  </div>
                  <div className="flex items-center justify-between">
                    <span>
                      <strong className="text-[#CCFF00]">Loss:</strong> 0 points
                    </span>
                  </div>
                </div>
                <p>
            ...
            >
              ...
              >
                ...
                <div className="bg-[#2a2a2a] rounded-lg p-4 space-y-3">
                  <div>
                    <p className="text-[#CCFF00] font-bold">1. Head-to-Head</p>
                  ...
                  <div>
                    <p className="text-[#CCFF00] font-bold">3. Goals Scored</p>
                    <p className="text-sm">
            ...
            >
              ...
              >
                <p>
                  <strong className="text-[#CCFF00]">Elimination Draws:</strong>{" "}
                ...
                <p>
                  <strong className="text-[#CCFF00]">Penalty Kicks:</strong> 5
            ...
            >
              ...
              >
                <p>
                  <strong className="text-[#CCFF00]">Roster Size:</strong>{" "}
            ...
            >
              ...
              >
                <div>
                  <p className="text-[#CCFF00] font-bold mb-2">Yellow Card</p>
                ...
                <div>
                  <p className="text-[#CCFF00] font-bold mb-2">Red Card</p>
                  <ul className="list-disc list-inside space-y-1 text-sm">
                    <li>Immediate ejection from game</li>
                  </ul>
                </div>
                <div>
                  <p className="text-[#CCFF00] font-bold mb-2">
            ...
            >
              ...
              >
                <div>
                  <p className="text-[#CCFF00] font-bold mb-2">Minor Weather</p>
                  <p className="text-sm">
            ...
            >
              ...
              >
                <div>
                  <p className="text-[#CCFF00] font-bold mb-2">Players</p>
                  <ul className="list-disc list-inside space-y-1 text-sm">
                ...
                <div>
                  <p className="text-[#CCFF00] font-bold mb-2">Coaches</p>
                  <ul className="list-disc list-inside space-y-1 text-sm">
                ...
                <div>
                  <p className="text-[#CCFF00] font-bold mb-2">Spectators</p>
                  <ul className="list-disc list-inside space-y-1 text-sm">
            ...
            {/* Download PDF CTA */}
            <section className="bg-linear-to-r from-[#CCFF00]/10 to-[#00CCFF]/10 border-2 border-[#CCFF00] rounded-lg p-6 md:p-8 text-center">
              ...
              <button
                className="inline-block bg-[#CCFF00] text-black font-bold py-3 px-8 rounded-lg hover:bg-[#B8E600] transition"
                style={{ fontFamily: "Open Sans" }}
              >
                📄 Download PDF
              </button>
