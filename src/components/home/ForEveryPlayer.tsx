...
const divisions = [
  {
    ...
    icon: Users,
    borderColor: "border-l-4 border-[#B8E600]",
    iconBg: "bg-[#B8E600]",
    iconColor: "text-white",
    priceColor: "text-[#B8E600]",
    bulletColor: "text-[#B8E600]",
    categories: [
      "U9/U10 Boys & Girls",
      "U11/U12 Boys & Girls",
      "U13/U14 Boys & Girls",
...
const ForEveryPlayer = () => {
  return (
    <section className="relative w-full bg-black py-16 md:py-24 overflow-hidden">
      ...
      {/* Watermark: blurred, contained, hidden on small screens so mobile stays clean/dark */}
      <div className="absolute inset-0 overflow-hidden pointer-events-none hidden md:block">
        <Image
          src={waterMarkTop}
          alt=""
          className="w-80 h-150 object-contain blur-md opacity-20"
        />
      </div>
