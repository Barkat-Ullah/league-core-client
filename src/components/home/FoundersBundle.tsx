    ...
    <section className="w-full  py-16 md:py-24 relative overflow-hidden min-h-125 flex items-center justify-center">
      ...
      <div className="max-w-[90%] mx-auto px-4 sm:px-6 relative z-10 text-center">
        ...
        <button
          ...
          className="bg-[#CCFF00] hover:bg-[#B8E600] text-black font-bold py-3 px-8 rounded-lg shadow-lg transition mb-6"
        >
          Buy Founders Bundle
        </button>
        ...
        <p className="text-gray-400 text-sm">
          Have questions?{" "}
          <Link href="/faq/#contact" className="text-[#CCFF00] hover:underline">
            Contact us
          </Link>
        </p>
      </div>
