...
const iconMap = [
  {
    Icon: Trophy,
    color: "text-[#B8E600]",
    ring: "border-[#B8E6001A]/30 bg-[#B8E6001A]/90",
    title: "Credentialed Coaches",
    border: "border-[#B8E600]/20",
  },
  {
    Icon: Users,
    color: "text-[#EBB736]",
      ...
      <div className="mx-auto w-full max-w-7xl px-4 py-14 sm:px-6 md:py-16 lg:px-8">
        <div className="grid items-center gap-7 md:grid-cols-[1.02fr_0.98fr] md:gap-10">
          <div className="text-center md:text-left">
            ...
            <p className="mt-3 text-sm font-semibold text-[#ccff00] md:text-base">
              Work hard. Get better. Come back.
            </p>
          </div>

          <div className="relative aspect-16/10 overflow-hidden rounded-md border border-[#ccff00]/35 shadow-[0_18px_38px_rgba(0,0,0,0.45)] sm:aspect-video lg:aspect-4/3">
            <Image
              src="/camp/series.png"
