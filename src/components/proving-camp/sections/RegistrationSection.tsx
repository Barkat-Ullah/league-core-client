        ...
        >
          <div className="space-y-4 rounded-lg border border-white/5 bg-white/5 p-4">
            ...
            <label className="text-sm text-gray-200">
              Active Camp <span className="text-[#ccff00]">*</span>
            ...
            <div>
              <div className="flex flex-col gap-1 sm:flex-row sm:items-end sm:justify-between">
                <p className="text-sm text-gray-200">
                  Select Week(s) <span className="text-[#ccff00]">*</span>
                </p>
              ...
              <DropdownMenu>
                <DropdownMenuTrigger asChild>
                  <button
                    type="button"
                    className="mt-2 flex w-full min-h-12 items-center justify-between gap-3 rounded border border-white/15 bg-black px-3 py-2.5 text-left text-sm text-gray-100 outline-none transition-colors hover:border-[#ccff00]/50 focus:border-[#ccff00] focus:ring-1 focus:ring-[#ccff00]"
                  >
                ...
                <DropdownMenuContent className="w-[min(100vw-2rem,42rem)] border border-white/10 bg-[#101010] p-0 text-gray-100 shadow-2xl">
                  <div className="flex items-center justify-between gap-3 px-4 py-3">
                    ...
                    <button
                      ...
                      className="text-xs font-semibold text-[#ccff00] hover:text-[#ccff00]/80"
                    >
                      Clear all
                    </button>
                  </div>
              ...
              {selectedWeekIds.length > 0 ? (
                <div className="mt-3 flex flex-wrap gap-2">
                  {selectedWeekLabels.map((label: string) => (
                    <span
                      key={label}
                      className="rounded-full border border-[#ccff00]/30 bg-[#ccff00]/10 px-3 py-1 text-xs font-medium text-[#ccff00]"
                    >
                      {label}
                    </span>
                  ))}
          ...
          <div className="space-y-4 rounded-lg border border-white/5 bg-white/5 p-4">
            <div className="flex flex-col gap-2 sm:flex-row sm:items-center sm:justify-between">
              ...
              <button
                ...
                className="rounded-md border border-[#ccff00]/30 px-3 py-2 text-xs font-semibold text-[#ccff00] transition-colors hover:border-[#ccff00] hover:bg-[#ccff00]/10"
              >
                Add Another Kid
              </button>
            </div>
              ...
              {fields.map((field, index) => (
                ...
                >
                  ...
                  <div className="grid gap-4 md:grid-cols-2">
                    <label className="text-sm text-gray-200">
                      Player Name <span className="text-[#ccff00]">*</span>
                      <input
                    ...
                    <label className="text-sm text-gray-200">
                      Player Type <span className="text-[#ccff00]">*</span>
                      <select
                    ...
                    <label className="text-sm text-gray-200">
                      T-Shirt Size <span className="text-[#ccff00]">*</span>
                      <select
          ...
          <div className="space-y-4 rounded-lg border border-white/5 bg-white/5 p-4">
            ...
            <div className="grid gap-4 md:grid-cols-2">
              <label className="text-sm text-gray-200">
                Parent Name <span className="text-[#ccff00]">*</span>
                <input
          ...
          <button
            ...
            className="w-full rounded bg-[#ccff00] px-4 py-3 text-sm font-semibold text-black transition hover:bg-[#ccff00] disabled:cursor-not-allowed disabled:opacity-60"
          >
            {isRegistering
              ? "Registering..."
