      ...
      <div className="mx-auto w-full max-w-7xl px-4 sm:px-6 lg:px-8">
        ...
        <div className="mx-auto max-w-6xl space-y-2.5">
          {campFaqItems.map((item) => (
            <details
              key={item.q}
              className="group overflow-hidden rounded-lg border border-white/10 bg-[#161616] transition open:border-[#ccff00]/50"
            >
              <summary className="flex list-none cursor-pointer items-center justify-between gap-3 px-4 py-4 text-left marker:content-none sm:px-5">
                ...
                <ChevronDown className="h-4 w-4 shrink-0 text-[#ccff00] transition-transform duration-200 group-open:rotate-180" />
              </summary>
