  ...
  return (
    <article
      className={`relative h-full overflow-hidden rounded-md border p-4 shadow-[0_0_35px_rgba(9,196,220,0.08)] sm:p-5 ${
        isAM ? "border-[#ccff00]/50" : "border-white/20"
      } bg-[#0e1117]/20`}
    >
      <div
      ...
      <div className="relative">
        ...
        <div className="mt-4 space-y-3 text-sm text-gray-100">
          <p className="flex items-start gap-2">
            <Clock3 className="mt-0.5 h-4 w-4 text-[#ccff00]" />
            <span>
          ...
          <p className="flex items-start gap-2">
            <CalendarDays className="mt-0.5 h-4 w-4 text-[#ccff00]" />
            <span>
          ...
          <p className="flex items-start gap-2">
            <Users className="mt-0.5 h-4 w-4 text-[#ccff00]" />
            <span>
