        ...
        <div className="flex items-center justify-center">
          <div className="w-full max-w-6xl text-center">
            ...
            <div className="mt-7 flex items-center justify-center">
              <a
                href="#registration"
                className="w-full max-w-sm rounded-sm bg-[#ccff00] px-6 py-3 text-center text-sm font-semibold text-black transition hover:bg-[#ccff00]/80 sm:w-auto sm:max-w-none sm:px-7 sm:text-base md:text-lg"
              >
              ...
              <div className="mt-8 flex flex-wrap items-center justify-center gap-2">
                ...
                {allSchedules.map((schedule) => (
                  <a
                    key={schedule.season}
                    href="#registration"
                    className="inline-block rounded-full bg-gray-800 px-4 py-2 text-sm font-semibold text-[#ccff00] transition hover:bg-[#ccff00] hover:text-black"
                  >
