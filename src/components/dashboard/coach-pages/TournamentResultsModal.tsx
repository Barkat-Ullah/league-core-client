...
export function TournamentResultsModal({
  ...
  return (
    <div className="fixed inset-0 bg-black/50 backdrop-blur-sm flex items-center justify-center z-50 p-4">
      <div className="bg-black border border-[#CCFF00]/30 rounded-lg p-8 max-w-2xl w-full max-h-[90vh] overflow-y-auto">
        {/* Close Button */}
        <button
          onClick={onClose}
        ...
        <div className="space-y-4 mb-8 pb-8 border-b border-[#CCFF00]/30">
          {matches.map((match, idx) => (
            <div
              key={idx}
              className="flex items-center justify-between p-4 bg-black/40 border border-[#CCFF00]/10 rounded-lg"
            >
