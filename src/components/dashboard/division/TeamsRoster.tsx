    ...
    <div className="space-y-6">
      ...
      <div className="relative">
        ...
        <input
          ...
          className="w-full pl-10 pr-4 py-2 bg-gray-900/50 border border-gray-700 rounded-lg text-white placeholder-gray-500 focus:outline-none focus:border-[#CCFF00] transition-colors"
        />
      </div>
      ...
      <div className="grid grid-cols-3 gap-4 mt-8">
        ...
        <div className="bg-gray-900/50 border border-gray-800 rounded-lg p-4">
          ...
          <p className="text-2xl font-bold text-[#CCFF00]">$5,200</p>
        </div>
        <div className="bg-gray-900/50 border border-gray-800 rounded-lg p-4">
