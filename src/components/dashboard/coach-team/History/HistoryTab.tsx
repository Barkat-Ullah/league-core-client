    ...
    <div>
      ...
      {isError && (
        <div className="border border-red-500/30 bg-red-500/10 rounded-lg p-4 mb-6">
          ...
          <button
            onClick={() => refetch()}
            className="mt-3 px-4 py-2 bg-[#CCFF00] text-black font-bold text-sm rounded hover:bg-[#B8D800] transition"
          >
            Retry
          </button>
        </div>
      ...
      <div className="border border-[#CCFF00]/30 rounded-lg p-8 mb-8 bg-black/20 backdrop-blur">
        ...
        {listBusy ? (
          ...
          <div className="text-5xl font-bold text-[#CCFF00] mb-2">
      ...
      <div className="border border-[#CCFF00]/30 rounded-lg overflow-hidden bg-black/20 backdrop-blur">
        <div className="overflow-x-auto">
          <table className="w-full">
            <thead>
              <tr className="border-b border-[#CCFF00]/30 bg-black/40">
            ...
            <tbody>
              ...
              {listBusy &&
                Array.from({ length: 3 }).map((_, i) => (
                  <tr key={i} className="border-b border-[#CCFF00]/10">
              ...
              {!listBusy &&
                tournaments.map((t) => (
                  <tr
                    key={t.tournamentId}
                    className="border-b border-[#CCFF00]/10 hover:bg-[#CCFF00]/5 transition-colors"
                  >
          ...
          <div className="bg-black border border-[#CCFF00]/30 rounded-lg p-8 max-w-2xl w-full max-h-[90vh] overflow-y-auto relative scrollbar-hide">
            ...
            {!detailsBusy && histroyDetails?.data && (
              <>
                ...
                {/* Points row */}
                <div className="grid grid-cols-2 gap-4 mb-8">
                  <div className="border border-[#CCFF00]/20 rounded-lg p-4 bg-black/20">
                ...
                {histroyDetails.data.matches.length === 0 ? (
                  ...
                  <div className="space-y-4 mb-8">
                    {histroyDetails.data.matches.map((match, idx) => (
                      <div
                        key={match.matchId}
                        className="flex items-center justify-between pb-4 border-b border-[#CCFF00]/10 last:border-0"
                      >
                        <div>
                ...
                {/* Summary */}
                <div className="grid grid-cols-3 gap-4 mb-8 pb-8 border-b border-[#CCFF00]/30">
                  <div className="border border-[#CCFF00]/20 rounded-lg p-4 text-center">
                    <div
                      style={{ color: "#4ADE80" }}
            ...
            <button
              onClick={closeModal}
              className="w-full bg-[#CCFF00] text-black font-bold py-3 rounded-lg hover:bg-[#CCFF00]/90 transition-colors"
            >
              Close
            </button>
          </div>
