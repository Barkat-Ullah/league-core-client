          ...
          {!isEditing ? (
            ...
            <div className="flex gap-2">
              <button
                ...
                className="px-4 py-2 rounded bg-[#CCFF00] text-black font-bold disabled:opacity-50"
              >
            ...
            <div className="border-2 border-dashed border-[#CCFF00] rounded-lg p-8 w-40 h-40 flex items-center justify-center bg-[#CCFF00]/10 hover:bg-[#CCFF00]/20 transition">
              {displayLogo ? (
                ...
                <div className="text-center">
                  <Upload className="w-6 h-6 text-[#CCFF00] mx-auto" />
            ...
            <div>
              ...
              {isEditing ? (
                <input
                  ...
                  className="mt-1 w-full bg-[#222] border border-[#CCFF00] text-white px-3 py-2 rounded font-bold text-base focus:outline-none focus:ring-2 focus:ring-[#CCFF00]"
                  autoFocus
                />
              ) : (
