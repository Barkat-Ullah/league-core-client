      ...
      <DialogContent className="bg-[#1a1a1a] border border-gray-800 max-w-xl max-h-[90vh] overflow-y-auto">
        ...
        <div className="py-2 space-y-2">
          ...
          <div>
            ...
            <input
              ...
              className="w-full bg-gray-900 text-white border border-gray-700 rounded px-4 py-3 focus:outline-none focus:border-[#CCFF00]"
            />
          </div>
          ...
          <div>
            ...
            <div className="relative">
              <input
                ...
                onChange={handleInputChange}
                className="w-full bg-gray-900 text-white border border-gray-700 rounded px-4 py-3 pr-16 focus:outline-none focus:border-[#CCFF00]"
              />
              <button
                type="button"
        ...
        <div className="flex gap-3 pt-6 border-t border-gray-800">
          ...
          <button
            ...
            disabled={isSubmitting}
            className="flex-1 px-4 py-3 bg-[#CCFF00] text-black font-bold rounded hover:bg-[#B8E600] transition disabled:opacity-60 disabled:cursor-not-allowed"
          >
