      ...
      <div className="min-h-screen bg-[#0A0A0A] text-white p-6">
        <div className="max-w-7xl mx-auto space-y-6">
          <div className="bg-linear-to-br from-gray-900 to-[#1a1a1a] border border-gray-800 rounded-xl p-8">
            ...
            <button
              onClick={() => refetch()}
              className="mt-4 bg-[#CCFF00] text-black font-bold px-4 py-2 rounded-lg hover:bg-[#B8E600] transition-colors"
            >
              Retry
            </button>
          </div>
            ...
            {nextMatch ? (
              <div className="space-y-4">
                ...
                <div className="flex items-start gap-3">
                  <Trophy className="text-[#CCFF00] mt-1" size={20} />
                  <div>
                ...
                <div className="flex items-start gap-3">
                  <MapPin className="text-[#CCFF00] mt-1" size={20} />
                  <div className="flex-1">
                    ...
                    {nextMatch.mapLink && (
                      <a
                        ...
                        target="_blank"
                        rel="noreferrer"
                        className="inline-block mt-2 text-[#CCFF00] hover:underline"
                      >
                        Open map
                      </a>
                    )}
          ...
          {waiverPending && (
            <div className="bg-linear-to-br from-red-900/20 to-red-900/10 border-2 border-red-900/50 rounded-xl p-5 sm:p-6 flex flex-col justify-between">
              ...
              <Link href={"/dashboard/player/waiver-center"}>
                <button className="w-full bg-[#CCFF00] text-black font-bold py-3 rounded-lg hover:bg-[#B8E600] transition-colors">
                  Sign Waiver Now
                </button>
              </Link>
            </div>
