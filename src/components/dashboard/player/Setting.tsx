    ...
    <div className="min-h-screen bg-[#0A0A0A] text-white p-4 sm:p-6">
      <div className="max-w-7xl mx-auto space-y-4 sm:space-y-6">
        <div className="bg-linear-to-br from-gray-900 to-[#1a1a1a] border border-gray-800 rounded-xl p-5 sm:p-8">
              ...
              <div className="shrink-0 mx-auto md:mx-0">
                <div className="relative w-28 h-28 sm:w-32 sm:h-32 bg-gray-800 rounded-full flex items-center justify-center border-4 border-gray-700 overflow-hidden">
                  ...
                  <button
                    ...
                    disabled={!profileEditMode || isProfileBusy}
                    className="absolute bottom-0 right-3 bg-[#CCFF00] text-black p-2 rounded-full hover:bg-[#B8E600] transition-colors disabled:opacity-60 disabled:cursor-not-allowed"
                      ...
                      render={({ field }) => (
                        <div>
                          <input
                            ...
                            className="w-full bg-gray-900 border border-gray-700 rounded-lg px-4 py-2 text-white focus:outline-none focus:border-[#CCFF00] disabled:opacity-60"
                          />
                          {errors.fullName && (
                  ...
                  {profileEditMode ? (
                    <>
                      <button
                        ...
                        disabled={isProfileBusy}
                        className="flex-1 bg-[#CCFF00] text-black font-bold py-2 rounded-lg hover:bg-[#B8E600] transition-colors disabled:opacity-60 disabled:cursor-not-allowed"
                      >
          ...
          {/* Change Password */}
          <div className="mb-8 pb-8 border-b border-gray-800">
            <h3 className="text-[#CCFF00] font-bold text-lg mb-4 uppercase tracking-wider">
              Change Password
            </h3>
            ...
            >
              <div>
                ...
                <input
                  ...
                  disabled={isChanging}
                  className="w-full bg-gray-900 border border-gray-700 rounded-lg px-4 py-2 text-white placeholder-gray-600 focus:outline-none focus:border-[#CCFF00] disabled:opacity-60"
