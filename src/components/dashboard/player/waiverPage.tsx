            ...
            >
              {isLoading ? (
                ...
                <>
                  ...
                  <button
                    onClick={openModal}
                    className="w-full bg-[#CCFF00] text-black font-bold py-3 rounded-lg hover:bg-[#B8E600] transition-colors text-sm"
                  >
                    Sign Digital Waiver
                  </button>
                </>
                ...
                <div className="flex flex-col sm:flex-row sm:items-center items-start justify-between gap-4">
                  ...
                  <button
                    type="button"
                    onClick={onDownload}
                    className="flex items-center gap-2 text-[#CCFF00] hover:text-[#B8E600] transition-colors font-semibold text-sm whitespace-nowrap"
                  >
                    <Download size={18} />
                    Download PDF
                  </button>
              ...
              <div className="bg-gray-900 border-2 border-[#CCFF00] rounded-xl max-w-2xl max-h-[85vh] overflow-y-auto scrollbar-hide w-full">
                ...
                >
                  ...
                  <div className="bg-gray-800 rounded-lg p-4">
                    <h3 className="text-[#CCFF00] font-bold mb-4 uppercase text-sm tracking-wider">
                  ...
                  <div>
                    ...
                    <input
                      ...
                      className="w-full bg-gray-800 border border-gray-700 rounded-lg px-4 py-3 text-white placeholder-gray-600 focus:outline-none focus:border-[#CCFF00]"
                    />
                    <div className="mt-2 flex items-center justify-between">
                      ...
                      {watchedAgree && playerFullName && (
                        <button
                          ...
                          className="text-[#CCFF00] text-xs font-semibold hover:text-[#B8E600]"
                        >
                          Use registered name
                        </button>
                      )}
                  ...
                  <button
                    type="submit"
                    disabled={isSigning}
                    className="w-full bg-[#CCFF00] text-black font-bold py-3 rounded-lg transition-colors uppercase tracking-wider disabled:opacity-60 disabled:cursor-not-allowed"
                  >
