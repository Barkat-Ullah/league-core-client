            ...
            <div className="shrink-0">
              <div className="relative w-32 h-32 bg-gray-800 rounded-full flex items-center justify-center border-4 border-gray-700 overflow-hidden">
                ...
                <button
                  ...
                  className="absolute bottom-0 right-2 bg-[#CCFF00] text-black p-2 rounded-full hover:bg-[#B8E600] transition-colors"
                >
                  <Camera size={25} />
                </button>
              </div>
              ...
              <div>
                ...
                {profileEditMode ? (
                  <input
                    ...
                    className="w-full bg-gray-900 border border-gray-700 rounded-lg px-4 py-2 text-white focus:outline-none focus:border-[#CCFF00]"
                  />
                ) : (
                  <input
                    type="text"
                ...
                {profileEditMode ? (
                  <>
                    <button
                      ...
                      disabled={isUpdating}
                      className="flex-1 bg-[#CCFF00] text-black font-bold py-2 rounded-lg hover:bg-[#B8E600] transition-colors disabled:opacity-60"
                    >
          ...
          <div className="space-y-4 mb-6">
            <div>
              ...
              <input
                ...
                className="w-full bg-gray-900 border border-gray-700 rounded-lg px-4 py-2 text-white placeholder-gray-500 focus:outline-none focus:border-[#CCFF00]"
              />
            </div>
