...
const inputClassName =
  "h-11 w-full rounded-md border border-[#1C2B4A] bg-[#0B1630] px-3 text-sm text-[#F0F5FF] placeholder:text-[#73809A] outline-none transition-colors focus:border-[#CCFF00]";
const textAreaClassName =
  "w-full rounded-md border border-[#1C2B4A] bg-[#0B1630] px-3 py-2 text-sm text-[#F0F5FF] placeholder:text-[#73809A] outline-none transition-colors focus:border-[#CCFF00]";
