        ...
        <div className="flex-1 overflow-y-auto space-y-4 px-3 py-4 sm:px-4">
          ...
          <div className="space-y-4">
            ...
            <DropdownMenu>
              <DropdownMenuTrigger asChild>
                <button
                  type="button"
                  className="mt-2 flex w-full h-10 items-center justify-between gap-3 rounded border border-white/15 bg-black px-3 py-1.5 text-left text-sm text-gray-100 outline-none transition-colors hover:border-[#CCFF00]/50 focus:border-[#CCFF00]"
                >
          ...
          <div>
            ...
            <textarea
              ...
              rows={4}
              className="w-full rounded-md border border-[#1D2C4A] bg-[#1A1E27] px-3 py-2 text-sm text-[#EDF3FF] outline-none focus:border-[#CCFF00] disabled:cursor-not-allowed disabled:opacity-60"
            />
