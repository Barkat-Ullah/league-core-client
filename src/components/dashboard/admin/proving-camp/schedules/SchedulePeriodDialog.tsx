...
export default function SchedulePeriodDialog({
  ...
  return (
    <Dialog open={open} onOpenChange={onOpenChange}>
      <DialogContent className="max-h-[92vh] w-[calc(100vw-2rem)] max-w-5xl overflow-y-auto border border-[#1D2A45] bg-[#06090F] p-0 text-white">
        ...
        <div className="space-y-4 px-4 py-5 sm:px-6">
          <div>
            ...
            <input
              ...
              className="h-11 w-full rounded-md border border-[#1D2C4A] bg-[#0A1630] px-3 text-sm text-[#EDF3FF] outline-none focus:border-[#CCFF00]"
            />
          </div>
