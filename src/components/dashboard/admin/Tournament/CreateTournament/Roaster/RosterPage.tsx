        ...
        <div className="mb-4">
          <div className="relative">
            ...
            <input
              ...
              className="w-full bg-gray-800 border border-gray-700 rounded-lg pl-10 pr-4 py-2 text-white placeholder-gray-500 focus:outline-none focus:border-[#CCFF00]"
            />
          </div>
        </div>
                ...
                <button
                  ...
                  className={`w-full text-left p-3 rounded-lg border transition-all ${
                    selectedPlayer?.id === player.id
                      ? "bg-gray-800 border-l-2 border-l-[#CCFF00] border-t-gray-700 border-r-gray-700 border-b-gray-700"
