  ...
  return (
    <div className="fixed inset-0 bg-black/70 flex items-center justify-center z-50">
      <div className="bg-[#111] border border-gray-800 rounded-xl w-105 p-6">
        <h2 className="text-xl font-bold mb-4 text-[#CCFF00]">Invite Team</h2>
        ...
        <div className="flex justify-end gap-3">
          ...
          <button
            ...
            className="bg-[#CCFF00] text-black font-semibold px-4 py-2 rounded-lg hover:bg-[#B8E600] disabled:opacity-60"
          >
