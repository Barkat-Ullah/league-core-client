    ...
    <div className="min-h-screen bg-[#0A0A0A] text-white p-6">
      <div className="max-w-7xl mx-auto">
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-6 mb-8">
          ...
          >
            <div className="bg-[#CCFF00] rounded-lg p-3 flex items-center justify-center w-12 h-12">
            ...
            {isLoading ? (
              <div className="flex items-center gap-2">
                <Loader className="w-5 h-5 animate-spin text-[#CCFF00]" />
              </div>
            ) : error ? (
        ...
        <div className="mb-8">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
            <Link href="/dashboard/admin/tournament/create">
              <button className="w-full bg-[#CCFF00] hover:bg-[#B8E600] text-black font-bold py-4 rounded-xl transition-all flex items-center justify-center gap-3 group">
                <Plus
                  size={24}
