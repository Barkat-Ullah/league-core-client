    ...
    >
      ...
      <SidebarFooter className="bg-[#0A0A0A] border-t border-gray-800 px-4 py-3 space-y-3">
        ...
        <button
          ...
          className="w-full flex items-center justify-center gap-2 text-[#CCFF00] hover:text-[#CCFF00]/80 font-semibold py-2.5 px-3 rounded-lg hover:bg-gray-900 transition-colors text-sm"
        >
          <LogOut size={18} />
          <span>Logout</span>
        </button>
