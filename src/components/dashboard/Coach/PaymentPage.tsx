    ...
    <div className="min-h-screen bg-[#0A0A0A]">
      <div className="max-w-6xl mx-auto p-4 md:p-6">
        ...
        <div className="mb-4 flex flex-col md:flex-row md:items-center md:justify-between gap-3">
          <div className="text-sm text-gray-400">
            {meta ? (
              <>
                ...
                transactions
                {isFetching ? (
                  <span className="ml-2 text-[#CCFF00]">Updating…</span>
                ) : null}
              </>
            ) : (
              <span>—</span>
          ...
          <div className="flex items-center gap-3">
            ...
            <select
              ...
              className="bg-black/30 border border-[#CCFF00]/30 text-white rounded px-3 py-2 text-sm"
            >
              {[5, 10, 20, 50].map((n) => (
            ...
            <div className="flex items-center gap-2">
              <button
                ...
                className="px-3 py-2 rounded border border-[#CCFF00]/30 text-white disabled:opacity-40 hover:bg-[#CCFF00]/10"
              >
                Prev
              </button>
              <button
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-4 sm:gap-6">
          <div className="border border-[#CCFF00]/30 rounded-lg p-5 sm:p-8 bg-black/20 backdrop-blur">
