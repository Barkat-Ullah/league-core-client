  ...
  return (
    <div className="space-y-4">
        ...
        <SidebarMenu>
          <SidebarMenuItem>
            <SidebarMenuButton
              ...
              className="text-[#B3B3B3] border rounded-sm py-6 w-full text-base sm:text-lg font-medium cursor-pointer flex items-center justify-center gap-2 transition-all duration-300 ease-out hover:bg-[#CCFF00] hover:text-black hover:shadow-md hover:-translate-y-px active:translate-y-0 active:scale-[0.98]"
            >
      ...
      <Dialog open={open} onOpenChange={setOpen}>
        <DialogContent className=" sm:max-w-sm bg-gray-900 text-center text-[#CCFF00] flex flex-col justify-center items-center mx-auto">
          <AlertDialogHeader className="w-full mx-auto justify-center items-center">
            <div className="flex justify-center mb-2">
              <CircleQuestionMark className="w-30 h-30 text-[#CCFF00]" />
            </div>
